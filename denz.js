...
try {
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                ...
                case 9: jamss = "𝙵𝙾𝙾𝙳 𝙺𝙰𝚉𝙷𝙸𝙲𝙷𝙸 🍜️"; break;
